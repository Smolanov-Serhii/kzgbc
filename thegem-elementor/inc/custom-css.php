...
.portfolio-filters-list .filter-item .list ul li a span.count,
...
.product .onsale:after {
	border-left-color: <?php echo thegem_get_option('styled_elements_color_1'); ?>;
	border-right-color: <?php echo thegem_get_option('styled_elements_color_1'); ?>
}
.quick-view-button {
...
.product .new-label:after {
	border-left-color: <?php echo thegem_get_option('styled_elements_color_4'); ?>;
	border-right-color: <?php echo thegem_get_option('styled_elements_color_4'); ?>
}
