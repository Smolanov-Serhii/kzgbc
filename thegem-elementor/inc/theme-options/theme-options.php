    ...
    function savePageOptions($post_id) {
        ...
        switch ($post->post_type) {
            ...
            case 'product':
                ...
                $product_gallery = thegem_get_sanitize_product_gallery_data(0, array(
                ...
                update_post_meta($post_id, 'thegem_product_gallery_data', $product_gallery);
...
//print_r($page_data);
        switch ($post->post_type) {
            ...
            case 'product':
                ...
                $product_gallery = thegem_get_sanitize_product_gallery_data($post->ID);
                $page_data['product_item_data'] = array(
                    ...
                    'product_layout_settings' => $product_gallery['product_layout_settings'],
                    'product_gallery' => $product_gallery['product_gallery'],
                    'product_gallery_type' => $product_gallery['product_gallery_type'],
                    'product_gallery_show_image' => $product_gallery['product_gallery_show_image'],
                    'product_gallery_zoom' => $product_gallery['product_gallery_zoom'],
                    'product_gallery_lightbox' => $product_gallery['product_gallery_lightbox'],
                    'product_gallery_labels' => $product_gallery['product_gallery_labels'],
                    'product_gallery_label_sale' => $product_gallery['product_gallery_label_sale'],
                    'product_gallery_label_new' => $product_gallery['product_gallery_label_new'],
                    'product_gallery_label_out_stock' => $product_gallery['product_gallery_label_out_stock'],
                    'product_gallery_auto_height' => $product_gallery['product_gallery_auto_height'],
                    'product_gallery_elements_color' => $product_gallery['product_gallery_elements_color'],
                );
                break;
        }
