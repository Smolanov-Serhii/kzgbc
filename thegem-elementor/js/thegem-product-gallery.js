(function ($) {
    ...
    function updateProductGallery() {
        ...
        $galleryElement.thegemPreloader(function () {
            ...
            // Changed dots color
            function changedDotsColor() {
                $('.owl-carousel .owl-dot span', $galleryElement).css('background-color', '#e2e9ed');
                $('.owl-carousel .owl-dot.active span', $galleryElement).css('background-color', $galleryElement.attr('data-colors'));
            }
